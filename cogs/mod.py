...
class mod():
    ...
    async def kick(self, ctx, user: discord.Member, *reason):
        ...
        embed = discord.Embed(title="", description=user.mention + " was kicked!", color=0xffbc77)
        ...
        embed.set_author(name="kisak-valve", url="https://github.com/kisak-valve")
        ...
        dm.set_author(name="kisak-valve", url="https://github.com/kisak-valve")
    ...
    async def ban(self, ctx, user: discord.Member, *reason):
        ...
        if reason == "":
            reason = "None was specified"
        embed = discord.Embed(title="", description=user.mention + ",was banned!", color=0xffbc77)
        embed.add_field(name="User id", value=user.id, inline=True)
        embed.add_field(name="Reason", value=reason, inline=False)
        embed.add_field(name="Server join date", value=user.joined_at, inline=False)
        embed.add_field(name="Discord join date", value=user.created_at.date(), inline=False)
